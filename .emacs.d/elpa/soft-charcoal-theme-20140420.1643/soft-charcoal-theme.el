...
(custom-theme-set-faces
 ...
 '(font-lock-variable-name-face ((t (:foreground "#b19779"))))
 '(font-lock-warning-face ((t (:foreground "#ffffff" :background "#ff6523"))))
 '(link ((t (:foreground "#54686d"))))
 '(org-hide ((t (:foreground "#708090"))))
 '(org-level-1 ((t (:normal t :foreground "#54686d" :height 1.1))))
 '(org-level-2 ((t (:normal nil :foreground "#7e8aa2"))))
 '(org-level-3 ((t (:normal t :foreground "#df9f2d"))))
 '(org-level-4 ((t (:normal nil :foreground "#af4f4b"))))
 ...
 '(org-agenda-structure ((t (:weight normal :foreground "#e3e3e3"))))
 '(org-agenda-date ((t (:foreground "#8aa234" :height 1.2))))
 '(org-agenda-date-weekend ((t (:weight normal :foreground "#808bed"))))
 '(org-agenda-date-today ((t (:weight normal :foreground "#8aa234" :height 1.4))))
