...
pushd ..\build
cl -Oi -W4 -WX -wd4201 -wd4100 -wd4189 -FC -Z7 -Fm -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 ..\..\me_handmadehero\code\win32_handmade.cpp /link -subsystem:windows user32.lib gdi32.lib
popd
