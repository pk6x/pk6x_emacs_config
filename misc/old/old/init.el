...
;; w32-pipe-read-delay default value of 50 should be changed. This should not cause any issue on
;; today's version of Windows. The default value of 50 may be lowered in mainline Emacs in future versions
...
;; irony-server communication performances (c.f. #321). The variable to customize is irony-server-w32-pipe-buffer-size.
...
(define-key global-map (read-kbd-macro "\eb") 'ido-switch-buffer)
(define-key global-map (read-kbd-macro "\eB") 'ido-switch-buffer-other-window)
...
(define-key global-map (kbd "\eo") 'end-of-line-and-indent-new-line)
...
(define-key global-map (kbd "\eO") 'beginning-of-line-and-indent-new-line)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(irony-eldoc flycheck-irony company-irony company irony rainbow-delimiters color-theme-modern visual-fill-column fill-column-indicator zenburn-theme yasnippet-snippets which-key use-package try modern-cpp-font-lock magit flycheck busybee-theme auto-complete ample-theme))
 '(tool-bar-mode nil))
(custom-set-faces
