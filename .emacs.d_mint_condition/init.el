...
(define-key global-map "\eJ" 'my-next-buffer)
(define-key global-map "\ek" 'delete-backward-char)
(define-key global-map "\eK" 'my-previous-buffer)
...
(define-key global-map "\eU" 'find-file-other-window)
...
(define-key global-map "\eY" 'cut-line)
